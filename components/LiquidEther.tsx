...
`;
    ...
    // The fluid sim runs at ~2fps on a software rasteriser, which drags the
    // whole page down with it. Those machines keep the dot field instead.
    if (!hasFastWebGL()) return;

    container.style.position = container.style.position || 'relative';
    container.style.overflow = container.style.overflow || 'hidden';

    let webgl: InstanceType<typeof WebGLManager>;
    try {
      ...
      // context creation can still fail after the probe succeeds
      return;
    }
