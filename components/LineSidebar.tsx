...
const LineSidebar = ({
  ...
  // controlled when `active` is supplied, uncontrolled otherwise
  const activeIndex = active !== undefined ? active : internalActive;
  const setActiveIndex = setInternalActive;
