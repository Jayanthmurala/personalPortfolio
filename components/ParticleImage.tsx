...
export default function ParticleImage(__props) {
  ...
  physicsRef.current = {
    ...
    repulsionMode, particleSize, particleShape, particleColor,
    singleColor, multiColors,
  };
  ...
  useEffect(() => {
    ...
    const draw = () => {
      ...
      const {
        hover: hOn, hoverType: ht, transition: tr, roamWidth: rw,
        roamHeight: rh, roamOpacity: rOp, roamShape: rs, repulsion: repOn,
        repulsionForce: rF, repulsionRadius: rR, repulsionMode: rMode,
